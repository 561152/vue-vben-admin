...
const tools = [
  {
    key: 'customer',
    title: '群发消息给客户',
    description: '企业统一选择要发送的客户，由添加客户的成员确认后发送给客户。消息内容仅管理员和负责人可创建。',
    icon: UserOutlined,
    actions: [
  ...
  },
  {
    key: 'group',
    title: '群发消息到企业的客户群',
    description: '管理员或负责人统一创建内容，群主收到通知后，可选择他管理的客户群并群发。',
    icon: TeamOutlined,
    actions: [
  ...
  },
  {
    key: 'moments',
    title: '企业发表到客户的朋友圈',
    description: '管理员或负责人编辑内容，选择可见的客户，成员确认后，可将内容发表到客户的朋友圈。还可与客户进行评论互动。',
      ...
      <Card v-for="tool in tools" :key="tool.key" class="h-full">
        <div class="flex flex-col h-full">
          <div class="flex items-start mb-4">
            ...
            <div class="flex-1">
              <h3 class="font-medium text-base">{{ tool.title }}</h3>
            </div>
          </div>
